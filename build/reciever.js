...
var Reciever = (function () {
    ...
    Reciever.prototype.recieveMessageFromExchange = function (ex) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this;
                        return [4, amqplib_1.default.connect(this.amqpURL)];
                    case 1:
                        _a.con = _c.sent();
                        _b = this;
                        return [4, this.con.createChannel()];
                    case 2:
                        _b.ch = _c.sent();
                        this.ch.assertExchange(ex, 'fanout', { durable: false });
                        return [4, this.ch.assertQueue('', { exclusive: true })];
                    case 3:
                        q = _c.sent();
...
var reciever = new Reciever('amqp://localhost');
